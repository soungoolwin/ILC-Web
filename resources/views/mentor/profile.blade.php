                        ...
                        <div class="flex justify-center mb-4">
                            <div class="relative">
                                <div id="profile-picture-container" class="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center border-2 border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors">
                                    @if (optional($mentor)->mentor_image)
                                        <img id="profile-image" src="{{ asset('mentor_image/' . $mentor->mentor_image) }}" alt="Mentor Image" class="w-full h-full rounded-full object-cover">
                                    @else
                                ...
                                <!-- <input type="file" id="profile-picture-input" name="mentor_image" accept="image/*" class="hidden"> -->
                            </div>
                        </div>

                        <!-- Separate Upload Form for Profile Picture -->
                        <form method="POST" action="{{ route('mentor.image.upload') }}" enctype="multipart/form-data" class="flex flex-col items-center space-y-3">
                            @csrf
                            <div class="flex items-center space-x-2 w-full max-w-sm">
                                <input type="file" id="profile-picture-input" name="mentor_image" accept="image/*"
