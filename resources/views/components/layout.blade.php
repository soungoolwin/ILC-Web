...
<body class="bg-gray-100">
    <div class="flex flex-col min-h-screen">
            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4 relative">
                    ...
                    @if (Auth::check())
                        ...
                        <a href="{{ route('student.dashboard') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Dashboard</a>
                            <a href="{{ route('student.profile') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Profile</a>
                            <!-- Appointments Dropdown -->
                            <div class="relative">
                                <button id="dropdownButton" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md focus:outline-none">Appointments</button>
                        ...
                        @elseif (Auth::user()->role === 'mentor')
                            <a href="{{ route('mentor.dashboard') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Dashboard</a>
                            <a href="{{ route('mentor.profile') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Profile</a>

                            <!-- Timetables Dropdown -->
                            <div class="relative">
                                <button id="dropdownButton" class="text-white focus:outline-none bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Timetables</button>
                                <div id="dropdownMenu" class="absolute mt-2 w-48 bg-white rounded-md shadow-lg hidden">
                        ...
                        @elseif (Auth::user()->role === 'team_leader')
                            <a href="{{ route('team_leader.dashboard') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Dashboard</a>
                            <a href="{{ route('team_leader.profile') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Profile</a>
                        ...
                        @elseif (Auth::user()->role === 'admin')
                            <a href="{{ route('admin.dashboard') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Dashboard</a>
                            <!-- Timetables Dropdown -->
                            <div class="relative">
                                <button id="dropdownButton" class="text-white focus:outline-none bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Timetables</button>
                                <div id="dropdownMenu" class="absolute mt-2 w-48 bg-white rounded-md shadow-lg hidden">
                            ...
                            <a href="{{ route('admin.profile') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Profile</a>
                        @endif

                        <!-- Logout Button -->
                        <form method="POST" action="{{ route('logout') }}" class="inline">
                            @csrf
                            <button type="submit" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Logout</button>
                        </form>
                    @else
                        <!-- Guest Links -->
                        <div class="relative">
                            <button id="registerDropdownButton" class="text-white focus:outline-none bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">
                                Register
                            </button>
                        ...
                        <!-- Login Link -->
                        <a href="{{ route('login') }}" class="text-white bg-[#8b6e73] px-2 py-1 rounded-md shadow-md">Login</a>
                    @endif
                </div>
            </div>
        </nav>
        ...
        <!-- Footer -->
        <footer class="bg-[#8E5C65] text-white text-center p-4 relative">
