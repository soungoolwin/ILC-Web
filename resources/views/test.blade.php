        ...
        <div class="mx-auto w-4/5">
            ...
            <div class="w-full flex flex-col lg:flex-row justify-center mb-8">
                ...
                <div class="flex flex-col items-left justify-left w-full bg-purple-100 p-4 shadow-md rounded-lg h-[300px] lg:h-[400px]">
                    <p> Download RSUGlobal! Newsletter Issue ( 003 ) <a href="{{ asset('images/News_November 2025.pdf') }}" download class="text-blue-600 underline mb-2 mt-2 hover:scale-105">
                        Here
                    </a></p>
                    <embed src="{{ asset('images/News_November 2025.pdf') }}#toolbar=0" type="application/pdf" width="100%" height="500px" class="mt-2 rounded shadow" />
                    <p class="font-thin text-xs text-gray-500 mt-2"> You can also download previous issues by logging in to the RSUGlobal! and visiting the Portal section. </p>
                </div>
            </aside>
